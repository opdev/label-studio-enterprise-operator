...
# my.domain/label-studio-enterprise-operator-bundle:$VERSION and my.domain/label-studio-enterprise-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= my.domain/label-studio-enterprise-operator
...
IMG ?= quay.io/yoza/lse-controller:latest
...
bundle-build: ## Build the bundle image.
	docker buildx build --platform linux/amd64,darwin/arm64 -f bundle.Dockerfile -t $(BUNDLE_IMG) .
